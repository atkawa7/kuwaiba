...
public class GoogleMapState extends AbstractComponentContainerState {
    ...
    public Set<GoogleMapsComponentControl> controls = new HashSet<>(
        Arrays.asList(GoogleMapsComponentControl.MapType, GoogleMapsComponentControl.Pan,
            GoogleMapsComponentControl.Rotate, GoogleMapsComponentControl.Scale,
            GoogleMapsComponentControl.StreetView, GoogleMapsComponentControl.Zoom));
