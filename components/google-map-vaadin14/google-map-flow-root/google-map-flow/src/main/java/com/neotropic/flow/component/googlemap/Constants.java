...
public class Constants {
    public static class Property {
        ...
        public static String DISABLE_DEFAULT_UI = "disableDefaultUi";
        public static String ZOOM_CONTROL = "zoomControl";
        public static String MAP_TYPE_CONTROL = "mapTypeControl";
        public static String SCALE_CONTROL = "scaleControl";
