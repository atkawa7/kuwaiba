...
public class PropertyGroupPrivileges extends PropertySupport.ReadWrite<String> {
    ...
    public PropertyGroupPrivileges(LocalUserGroupObject group) {
        ...
        private class PrivilegeTableModel extends AbstractTableModel {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                switch (columnIndex) { 
                    ...
                    case 1:
                        LocalPrivilege privilege = group.getPrivilege(LocalPrivilege.DEFAULT_PRIVILEGES[ 2 * rowIndex ]);
                        return (privilege != null && privilege.getAccessLevel() == LocalPrivilege.ACCESS_LEVEL_READ); //Neither read nor write
                    case 2:
                        privilege = group.getPrivilege(LocalPrivilege.DEFAULT_PRIVILEGES[ 2 * rowIndex ]);
