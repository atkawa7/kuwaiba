...
public class PropertyGroupDescription extends PropertySupport.ReadWrite<String>{
    ...
    public PropertyGroupDescription(LocalUserGroupObject group) {
        super("description", String.class, "Description", "The group's description");
        this.group = group;
    }
