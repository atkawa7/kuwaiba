...
/**
 * Action to delete a pool of customer
 * @author adrian martinez molina <adrian.martinez@kuwaiba.org>
 */
public class DeleteCustomersPoolAction extends AbstractAction{

    private CustomersPoolNode customersPoolNode;
    
    public DeleteCustomersPoolAction(CustomersPoolNode customersPoolNode) {
        this.customersPoolNode = customersPoolNode;
        putValue(NAME, java.util.ResourceBundle.getBundle("org/kuwaiba/management/services/Bundle").getString("LBL_DELETE_CUSTOMERS_POOL"));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if(JOptionPane.showConfirmDialog(null, java.util.ResourceBundle.getBundle("org/kuwaiba/management/services/Bundle").getString("LBL_DELETE_POOL"),
            ...
            if (CommunicationsStub.getInstance().deletePool(customersPoolNode.getPool().getOid())){
                customersPoolNode.getParentNode().getChildren().remove(new Node[]{customersPoolNode});
