...
/**
 * Action to shown subclasses of selected widget in the Class Hierarchy Scene
 * @author Johny Andres Ortega Ruiz <johny.ortega@kuwaiba.org>
 */
public class ShowSubclassAction extends GenericInventoryAction {
    public static final String COMMAND = "showSubclasses";
    ...
    public static ShowSubclassAction getInstance(ClassHierarchyScene scene) {
        if (scene == null)
            return null;
        return instance == null ? instance = new ShowSubclassAction(scene) : instance;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (Object selectedObject : selectedObjects) {
            scene.fireChangeEvent(new ActionEvent(selectedObject, AbstractScene.SCENE_CHANGE, ShowSubclassAction.COMMAND));
