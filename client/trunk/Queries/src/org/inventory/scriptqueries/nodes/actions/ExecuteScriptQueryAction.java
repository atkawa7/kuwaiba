 ...
 */
public class ExecuteScriptQueryAction extends GenericInventoryAction {
    
    public ExecuteScriptQueryAction() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        LocalScriptQueryResult result  = CommunicationsStub.getInstance().executeScriptQuery(scriptQuery.getId());
