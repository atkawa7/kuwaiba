...
public class CSVExportSettingsPanel extends javax.swing.JPanel implements ActionListener{
    ...
    public CSVExportSettingsPanel(Object [] settings) {
        initComponents();
        this.settings = settings = new Object[1];
    ...
    public void actionPerformed(ActionEvent e) {
        switch (cmbSeparator.getSelectedIndex()){
            case 0:
                settings[0] = CSVFilter.CHARACTER_COMMA;
                break;
            case 1:
                settings[0] = CSVFilter.CHARACTER_TAB;
                break;
            case 2:
                settings[0] = CSVFilter.CHARACTER_SPACE;
                break;
            case 3:
                settings[0] = CSVFilter.CHARACTER_PIPE;
                break;
            case 4:
                settings[0] = CSVFilter.CHARACTER_TILDE;
                break;
        }
    }
