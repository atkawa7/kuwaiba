...
public class ReleaseFromWarehouseAction extends GenericObjectNodeAction implements ComposedAction {
    
    public ReleaseFromWarehouseAction() {
        putValue(NAME, I18N.gm("release_from_warehouse"));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        List<LocalObjectLight> services = CommunicationsStub.getInstance().
            getSpecialAttribute(selectedObject.getClassName(), selectedObject.getId(), "warehouseHas"); //NOI18N
        ...
        if (services != null) {
            if (!services.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "There are not warehouses or virtual warehouses related to the selected object", 
    ...
    public void finalActionPerformed(ActionEvent e) {
        if (e != null && e.getSource() instanceof SubMenuDialog) {
            if (JOptionPane.showConfirmDialog(null, 
                    "Are you sure you want to release this warehouses?", I18N.gm("warning"), 
...
//                            ((ServiceChildren)selectedNode.getParentNode().getChildren()).addNotify();
                ...
                if (success)
                    NotificationUtil.getInstance().showSimplePopup(I18N.gm("success"), NotificationUtil.INFO_MESSAGE, "The selected resources were released from the warehouses");
            }
        }
    }
