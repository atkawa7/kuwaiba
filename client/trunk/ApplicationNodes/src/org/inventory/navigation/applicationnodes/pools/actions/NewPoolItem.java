 ...
 */
public class NewPoolItem extends AbstractAction{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        LocalObjectLight newObject = com.createObject(node.getPool().getClassName(), "Pool", node.getPool().getOid(), -1);
        if (newObject == null)
            ...
            node.getChildren().add(new ObjectNode[]{new ObjectNode(newObject)});
