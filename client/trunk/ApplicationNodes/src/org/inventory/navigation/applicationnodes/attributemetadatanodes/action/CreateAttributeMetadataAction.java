 ...
 */
public class CreateAttributeMetadataAction extends AbstractAction implements Presenter.Popup{
    
    private Node node;
    private CommunicationsStub com;

    public CreateAttributeMetadataAction() {
    ...
    public CreateAttributeMetadataAction(ClassMetadataNode node) {
        this();
        this.node = node;
    }
    ...
    public JMenuItem getPopupPresenter() {
        JMenuItem smiChildren = new JMenuItem(java.util.ResourceBundle.getBundle("org/inventory/navigation/applicationnodes/Bundle").getString("LBL_NEW_ATTRIBUTE"));
