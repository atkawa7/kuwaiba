...
public class ChildrenViewBuilder implements AbstractViewBuilder {
                        ...
                        if (reader.getName().equals(qNode)){
                            ...
                            if (reader.getName().equals(qEdge)){
                                ...
                                if (container != null){
                                    ...
                                    ObjectNodeWidget aSideWidget = (ObjectNodeWidget)scene.findWidget(aSideObject);

                                    LocalObjectLight bSideObject = new LocalObjectLight(bSide, null, null);
                                    ObjectNodeWidget bSideWidget = (ObjectNodeWidget)scene.findWidget(bSideObject);
    ...
    public void buildDefaultView(LocalObjectLight currentObject, List<LocalObjectLight> myNodes,
        ...
        for (LocalObject container : myPhysicalConnections) {            
            ...
            ObjectNodeWidget aSideWidget = (ObjectNodeWidget)scene.findWidget(parentsASide.get(currentObjectIndexASide == 0 ? 0 : currentObjectIndexASide - 1));
            int currentObjectIndexBSide = parentsBSide.indexOf(currentObject);
            ObjectNodeWidget bSideWidget = (ObjectNodeWidget)scene.findWidget(parentsBSide.get(currentObjectIndexBSide == 0 ? 0 : currentObjectIndexBSide - 1));
