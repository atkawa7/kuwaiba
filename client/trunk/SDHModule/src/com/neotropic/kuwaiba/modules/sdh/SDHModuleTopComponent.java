...
@TopComponent.Description(
        ...
        iconBase = "com/neotropic/kuwaiba/modules/sdh/res/icon.png",
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "com.neotropic.kuwaiba.modules.sdh.SDHModuleTopComponent")
...
@Messages({
    "CTL_SDHModuleAction=SDHModule",
    "CTL_SDHModuleTopComponent=SDHModule Window",
    "HINT_SDHModuleTopComponent=This is a SDHModule window"
})
public final class SDHModuleTopComponent extends TopComponent {
