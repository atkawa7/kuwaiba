...
public class UserNode extends AbstractNode{
    ...
    protected Sheet createSheet(){
        ...
        ss.put(new UserProperty("username", "Username", "User name used in the login process", object.getUserName()));
        ss.put(new UserProperty("lastname", "Last Name", "User's last name", object.getLastName()==null?"":object.getLastName()));
        ss.put(new UserProperty("firstname", "First Name", "User's first name", object.getFirstName()==null?"":object.getFirstName()));
        ss.put(new UserProperty("groups", "Groups", "Groups this user belongs to", getGroupsAsString(object.getGroups())));
        return s;      
    }
