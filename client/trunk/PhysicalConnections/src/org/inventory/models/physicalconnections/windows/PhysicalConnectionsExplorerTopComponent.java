 ...
 */
public class PhysicalConnectionsExplorerTopComponent extends TopComponent implements ExplorerManager.Provider{
    ...
    public PhysicalConnectionsExplorerTopComponent(PhysicalPathScene scene) {
        this.scene = scene;
