...
/**
 * Action to delete MPLS Tunnel 
 * @author Johny Andres Ortega Ruiz {@literal <johny.ortega@kuwaiba.org>}
 */
@ServiceProvider(service = GenericObjectNodeAction.class)
public class DeleteMPLSTunnelAction extends GenericObjectNodeAction {
    
    public DeleteMPLSTunnelAction() {
        this.putValue(NAME, "Delete MPLS Tunnel");         
    }
    ...
    public String[] appliesTo() {
        return new String[] {Constants.CLASS_MPLSTUNNEL};
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (JOptionPane.showConfirmDialog(null, 
                ...
                "Delete MPLS Tunnel", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE) == JOptionPane.OK_OPTION) {
