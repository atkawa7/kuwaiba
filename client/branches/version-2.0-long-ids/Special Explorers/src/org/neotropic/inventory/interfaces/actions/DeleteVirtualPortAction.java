...
/**
 * Action to delete Virtual Port 
 * @author Johny Andres Ortega Ruiz {@literal <johny.ortega@kuwaiba.org>}
 */
@ServiceProvider(service = GenericObjectNodeAction.class)
public class DeleteVirtualPortAction extends GenericObjectNodeAction {
    
    public DeleteVirtualPortAction() {
        this.putValue(NAME, "Delete Virtual Port");         
    }
    ...
    public String[] appliesTo() {
        return new String[] {Constants.CLASS_VIRTUALPORT};
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (JOptionPane.showConfirmDialog(null, 
                ...
                "Delete Virtual Port", JOptionPane.OK_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE) == JOptionPane.OK_OPTION) {
