...
public final class CreateMultipleTemplateElementAction extends CreateTemplateElementAction implements Presenter.Popup {
    ...
    public void actionPerformed(ActionEvent e) {        
        ...
        if (JOptionPane.showConfirmDialog(null, saveDialog, 
            ...
            List<LocalObjectLight> templateElements = CommunicationsStub.getInstance().createBulkTemplateElement(((JMenuItem)e.getSource()).getName(), selectedObject.getClassName(), Long.valueOf(selectedObject.getId()), numberOfObjects, namePattern);
