...
public class RemoteObjectList implements  Serializable {
    private List<RemoteObject> list;

    public RemoteObjectList() {
        list = new ArrayList<>();
    }
    
    public boolean add(RemoteObject element) {
        return list.add(element);
    }
    
    public boolean remove(RemoteObject element) {
        return list.remove(element);
    }
    
    public List<RemoteObject> getList() {
        return list;
    }
}