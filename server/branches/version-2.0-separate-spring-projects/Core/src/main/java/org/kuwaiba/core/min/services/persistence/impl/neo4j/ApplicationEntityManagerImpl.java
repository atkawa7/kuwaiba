...
package org.kuwaiba.core.min.services.persistence.impl.neo4j;
...
import org.kuwaiba.core.min.apis.persistence.exceptions.BusinessObjectNotFoundException;
import org.kuwaiba.core.min.apis.persistence.exceptions.OperationNotPermittedException;
import org.kuwaiba.core.min.apis.persistence.application.ApplicationEntityManager;
import org.kuwaiba.core.min.apis.persistence.ConnectionManager;
import org.kuwaiba.core.min.apis.persistence.application.ActivityLogEntry;
import org.kuwaiba.core.min.apis.persistence.application.BusinessRule;
import org.kuwaiba.core.min.apis.persistence.application.CompactQuery;
import org.kuwaiba.core.min.apis.persistence.application.ConfigurationVariable;
import org.kuwaiba.core.min.apis.persistence.application.ExtendedQuery;
import org.kuwaiba.core.min.apis.persistence.application.FavoritesFolder;
import org.kuwaiba.core.min.apis.persistence.application.GroupProfile;
import org.kuwaiba.core.min.apis.persistence.application.GroupProfileLight;
import org.kuwaiba.core.min.apis.persistence.application.Pool;
import org.kuwaiba.core.min.apis.persistence.application.Privilege;
import org.kuwaiba.core.min.apis.persistence.application.ResultRecord;
import org.kuwaiba.core.min.apis.persistence.application.Session;
import org.kuwaiba.core.min.apis.persistence.application.TemplateObject;
import org.kuwaiba.core.min.apis.persistence.application.TemplateObjectLight;
import org.kuwaiba.core.min.apis.persistence.application.UserProfile;
import org.kuwaiba.core.min.apis.persistence.application.Validator;
import org.kuwaiba.core.min.apis.persistence.application.ValidatorDefinition;
import org.kuwaiba.core.min.apis.persistence.application.ViewObject;
import org.kuwaiba.core.min.apis.persistence.application.ViewObjectLight;
import org.kuwaiba.core.min.apis.persistence.business.BusinessObject;
import org.kuwaiba.core.min.apis.persistence.business.BusinessObjectLight;
import org.kuwaiba.core.min.apis.persistence.business.BusinessObjectList;
import org.kuwaiba.core.min.apis.persistence.exceptions.ArraySizeMismatchException;
import org.kuwaiba.core.min.apis.persistence.exceptions.BusinessRuleException;
import org.kuwaiba.core.min.apis.persistence.metadata.AttributeMetadata;
import org.kuwaiba.core.min.apis.persistence.metadata.ClassMetadata;
import org.kuwaiba.core.min.apis.persistence.metadata.ClassMetadataLight;
import org.kuwaiba.core.min.apis.persistence.metadata.GenericObjectList;
import org.kuwaiba.core.min.apis.persistence.metadata.MetadataEntityManager;
import org.kuwaiba.core.min.services.persistence.cache.CacheManager;
import org.kuwaiba.core.min.services.persistence.util.Constants;
import org.kuwaiba.core.min.services.persistence.util.Util;
import org.kuwaiba.core.min.util.ChangeDescriptor;
import org.kuwaiba.core.min.util.dynamicname.DynamicName;
