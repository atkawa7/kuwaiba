 ...
 */
public class ObjectViewModule extends AbstractModule {

    public ObjectViewModule(WebserviceBean wsBean, RemoteSession session) {
    ...
    public void attachToMenu(MenuBar menuBar) {
        MenuItem outsidePlantMItem = menuBar.addItem("Object View", event -> {
            UI.getCurrent().navigate(ObjectViewComponent.ROUTE_VALUE);
        });
    }
    ...
    public Tab attachToMenu(Tabs tabs) {
        RouterLink routerLink = new RouterLink(null, ObjectViewComponent.class);
