...
package org.kuwaiba.core.min.apis.persistence.application;
...
public interface ApplicationEntityManager {
   ...
   /**
     ...
     * @throws InvalidArgumentException If the class provided is not a list type
     * @throws NotAuthorizedException If the user can't delete a list type item
     */
     ...
     * @throws ApplicationObjectNotFoundException In case that any of the devices contained within the main one
     * has a malformed <b>model</b> attribute.
     * @throws InvalidArgumentException If the structure is somehow malformed.
     */
     ...
     * @throws MetadataObjectNotFoundException If the provided class does not exist
     * @throws OperationNotPermittedException If the template class is abstract.
     */
     ...
     * @throws MetadataObjectNotFoundException If the object (or its parent) class could not be found
     * @throws ApplicationObjectNotFoundException If the parent object could not be found
     * @throws OperationNotPermittedException If the class provided to create the new element from is abstract.
     */
     ...
     * @return The summary of the changes
     * @throws MetadataObjectNotFoundException If any of the classes provided as arguments do not exist
     * @throws ApplicationObjectNotFoundException If the template element could not be found
     * @throws InvalidArgumentException If the arrays attributeNames and attributeValues have different sizes
     */
     ...
     * @return The summary of the changes
     * @throws MetadataObjectNotFoundException If the element's class could not be found.
     * @throws ApplicationObjectNotFoundException If the element could not be found.
     */
