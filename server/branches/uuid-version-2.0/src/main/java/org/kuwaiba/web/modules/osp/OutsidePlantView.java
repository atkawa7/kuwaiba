...
public class OutsidePlantView extends AbstractView<RemoteObjectLight> {
    ...
    public AbstractComponent getAsComponent() {
        try {
            ...
            if (AbstractMapProvider.class.isAssignableFrom(mapsProviderClass)) {
                ...
                mapProperties.put("center", this.viewMap.getSettings().get("center"));
    ...
    public void buildEmptyView() {
        ...
        this.viewMap.getSettings().put("center", new GeoCoordinate(mapCenterLatitude, mapCenterLongitude));
        
        try {
            this.viewMap.getSettings().put("zoom", aem.getConfigurationVariableValue("widgets.simplemap.zoom"));
        } catch (InventoryException ex) {
            this.viewMap.getSettings().put("zoom", OSPConstants.DEFAULT_ZOOM);
        }
    }
