        ...
        try{
            if(!asnName.isEmpty()){
                ...
                if(location == null)
                    ...
                    String createObjectId = bem.createObject("Cloud", location.getClassName(), location.getId(), attributes, -1);
        ...
        try{ 
            ...
            if(remotePort != null && remoteDevice != null){
                ...
                res.add(new SyncResult(dsConfigId, SyncResult.TYPE_INFORMATION, String.format("BGPLink will not be created for ASN %s(%s)", asnName, asn), 
                   String.format("Only source endpoint %s was found, no destination port was found related with ip %s", 
    ...
    */
    ...
    private BusinessObjectLight createRemoteProviderPort(BusinessObject remoteDevice, String bgpPeerRemoteAddr, String bgpPeerRemotePort) {
        try {
            ...
            String newPortId = bem.createObject("OpticalPort", remoteDevice.getClassName(), remoteDevice.getId(), attributes, -1);
