...
public class TopologyManagerUI extends VerticalLayout {
    ...
    private TopologyManagerDashboard dashboard; 
   
    public TopologyManagerUI() {
        super();
        setSizeFull();
    }
    ...
    private void createContent() throws InvalidArgumentException, MetadataObjectNotFoundException {                      
        dashboard = new TopologyManagerDashboard(ts, mem, aem, bem, resourceFactory, newTopologyViewVisualAction, deleteTopologyViewVisualAction);
