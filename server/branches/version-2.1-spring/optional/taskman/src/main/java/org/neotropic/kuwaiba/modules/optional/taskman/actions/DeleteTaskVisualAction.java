...
public class DeleteTaskVisualAction extends AbstractVisualAction<Dialog> {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (parameters.containsKey("task")) {
            ...
            ConfirmDialog wdwDeleteTask = new ConfirmDialog(ts.getTranslatedString("module.general.labels.confirmation"),
                    String.format("%s %s?", ts.getTranslatedString("module.taskman.task.actions.delete-task-confirm"), selectTask.getName()),
