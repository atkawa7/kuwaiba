 ...
 */
package org.neotropic.kuwaiba.modules.core.reports.defaults;
            ...
            NotAuthorizedException
    {
        ...
        for (BusinessObjectLight listOflogicalConfiguration : listOflogicalConfigurations) {
            ...
            if (ports == null) 
                ...
                DetailReportText +=  "<tr><td class=\"generalInfoLabel\">Creation date</td><td class=\"generalInfoValue\"><b>" + new Date(Long.valueOf((String) attributes.get("creationDate"))) + "</b> </td></tr></table>";
            }
