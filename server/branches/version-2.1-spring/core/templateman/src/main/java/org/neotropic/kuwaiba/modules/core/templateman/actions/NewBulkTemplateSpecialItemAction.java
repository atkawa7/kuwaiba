...
public class NewBulkTemplateSpecialItemAction extends AbstractAction {
    ...
    protected void init() {
        ...
        setCallback((parameters) -> {
            String tsElementclass = (String) parameters.get("tsElementclass");
            String tsElementParentClassName = (String) parameters.get("tsElementParentClassName");
            String tsElementParentId = (String) parameters.get("tsElementParentId");
            String tsElementName = (String) parameters.get("tsElementName");            
            try {
