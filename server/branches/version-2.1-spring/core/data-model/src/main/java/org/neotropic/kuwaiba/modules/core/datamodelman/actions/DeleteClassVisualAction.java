...
public class DeleteClassVisualAction extends AbstractVisualAction<Dialog> {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ClassMetadataLight seletedClass = null;
        ...
        wdwDeleteClass.getBtnConfirm().addClickListener((ev) -> {
            try {
                ...
                deleteClassAction.getCallback().execute(new ModuleActionParameterSet(
                        new ModuleActionParameter<>("className", classToDelete.getName())));

                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(ActionCompletedListener.ActionCompletedEvent.STATUS_SUCCESS,
                        ts.getTranslatedString("module.datamodelman.actions.class-deleted-success"), DeleteClassAction.class));
