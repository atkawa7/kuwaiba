...
public class NavLayout extends FlexLayout implements RouterLayout  {
    /**
     * Header component.
     */
    ...
    public void onAttach(AttachEvent ev) {
        ...
        this.lytFooter.add(new Html("Copyright <a href=\"https://www.neotropic.co\" target=\"_blank\">Neotropic</a>" + Calendar.getInstance().get(Calendar.YEAR)));
