    ...
    protected void init() {
        ...
        setCallback((parameters) -> {
            ...
            try {
                ...
                Notification.show(ts.getTranslatedString("module.taskman.task.actions.new-task-user-error"), 5000, Notification.Position.BOTTOM_CENTER);
                Logger.getLogger(NewTaskUserAction.class.getName()).log(Level.SEVERE, null, ex);
