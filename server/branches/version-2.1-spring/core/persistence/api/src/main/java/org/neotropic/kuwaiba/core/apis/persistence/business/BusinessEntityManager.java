...
public interface BusinessEntityManager extends AbstractEntityManager {
     ...
     * @throws MetadataObjectNotFoundException If the class provided does not exist
     */
    public FileObjectLight getFile(long fileObjectId, String className, String objectId) throws BusinessObjectNotFoundException, InvalidArgumentException, MetadataObjectNotFoundException;
    /**
