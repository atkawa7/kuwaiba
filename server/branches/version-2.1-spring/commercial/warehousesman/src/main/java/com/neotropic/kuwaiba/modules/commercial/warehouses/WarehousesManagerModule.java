 ...
 */
package com.neotropic.kuwaiba.modules.commercial.warehouses;
...
public class WarehousesManagerModule extends AbstractModule {
     ...
     * Module Id.
     */
    public static final String MODULE_ID = "warehousesman"; // NOI18N
    /**
    ...
    public String getName() {
        return ts.getTranslatedString("module.warehousesman.name");
    }

    @Override
    public String getDescription() {
        return ts.getTranslatedString("module.warehousesman.description");
    }
