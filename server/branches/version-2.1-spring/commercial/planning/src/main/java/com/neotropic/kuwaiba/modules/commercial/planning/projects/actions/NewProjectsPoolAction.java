    ...
    protected void init() {
        ...
        setCallback((parameters) -> {
            ...
            String instanceOfClass = (String) parameters.get("class");
                ...
                try {
                    aem.createRootPool(name, dispName, instanceOfClass, ApplicationEntityManager.POOL_TYPE_MODULE_COMPONENT);
                } catch (MetadataObjectNotFoundException ex) {
                    Logger.getLogger(NewProjectsPoolAction.class.getName()).log(Level.SEVERE, null, ex);
                }
