...
import com.neotropic.kuwaiba.modules.commercial.ospman.Map;
...
public class GoogleMaps implements Map {
    ...
    private HashMap<String, Object> getProperties(ApplicationEntityManager aem, TranslationService ts) {
        ...
        try {
            ...
            mapCenterLat = OutsidePlantConstants.DEFAULT_CENTER_LATITUDE;
        }
        
        try {
            mapCenterLng = (double) aem.getConfigurationVariableValue("widgets.simplemap.centerLongitude"); //NOI18N
        } catch (InventoryException ex) {
            mapCenterLng = OutsidePlantConstants.DEFAULT_CENTER_LONGITUDE;
        }
        ...
        try {
            ...
            properties.put(PROPERTY_ZOOM, OutsidePlantConstants.DEFAULT_ZOOM);
        }
