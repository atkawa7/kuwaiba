...
public interface KuwaibaSoapWebService {
   ...
   /**
    ...
    public RemoteConfigurationVariable getConfigurationVariable(@WebParam(name = "name")String name, 
            @WebParam(name = "sessionId")String sessionId) throws ServerSideException;
    ...
    public void updateValidatorDefinition(@WebParam(name = "validatorDefinitionId")long validatorDefinitionId, @WebParam(name = "name")String name, 
            ...
            @WebParam(name = "script")String script, @WebParam(name = "enabled")Boolean enabled, 
            @WebParam(name = "sessionId")String sessionId) throws ServerSideException;
