    ...
    public void createIPAMRoots() throws DatabaseException{
        try (Transaction tx = graphDb.beginTx())
        {
            ...
            if(IPv4RootNode == null) 
            {
                ...
                IPv4RootNode.setProperty(Constants.PROPERTY_DESCRIPTION, Constants.NODE_IPV4ROOT);
            ...
            if(IPv6RootNode == null) 
            {
                ...
                IPv6RootNode.setProperty(Constants.PROPERTY_DESCRIPTION, Constants.NODE_IPV6ROOT);
