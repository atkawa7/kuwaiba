...
public class WebserviceBean implements WebserviceBeanRemote {
    ...
    public void moveClass(String classToMoveName, String targetParentName, String ipAddress, String sessionId) throws ServerSideException{
        if (mem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("moveClass", ipAddress, sessionId);
    ...
    public List<ClassInfoLight> getSpecialPossibleChildren(String parentClassName, String ipAddress, String sessionId) throws ServerSideException {
        ...
        try {
            aem.validateWebServiceCall("getSpecialPossibleChildrenNoRecursive", ipAddress, sessionId);
    ...
    public long createService(String serviceClass, String customerClass, 
        ...
        if (bem == null || aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("createService", ipAddress, sessionId);
    ...
    public long createCustomer(String customerClass, String[] attributes, 
        ...
        if (bem == null || aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("createCustomer", ipAddress, sessionId);
            if (!mem.isSubClass("GenericCustomer", customerClass))
                throw new ServerSideException(String.format("Class %s is not a customer", customerClass));
    ...
    public RemoteObjectLight[] getServices(String customerClass, long customerId, String ipAddress, String sessionId) throws ServerSideException{
        if (bem == null || aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("getServices", ipAddress, sessionId);
            if (!mem.isSubClass("GenericCustomer", customerClass))
                throw new ServerSideException(String.format("Class %s is not a customer", customerClass));
    ...
    public long createGroup(String groupName, String description, List<Long> users, String ipAddress, String sessionId) throws ServerSideException {
        ...
        try {
            ...
            return aem.createGroup(groupName, description, users);
        } catch (InventoryException ex) {
            throw new ServerSideException(ex.getMessage());
        }
    }
    ...
    public void deletePool(long id, String ipAddress, String sessionId) throws ServerSideException {
        if (aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("deletePool", ipAddress, sessionId);
            aem.deletePool(id);
    ...
    public RemoteObjectLight[] getPoolItems(long poolId, int limit, String ipAddress, String sessionId) throws ServerSideException{
        if (aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("getPoolItem", ipAddress, sessionId);
    ...
    public ApplicationLogEntry[] getGeneralActivityAuditTrail(int page, int limit, String ipAddress, String sessionId) throws ServerSideException {
        if (aem == null)
            throw new ServerSideException("Can't reach the backend. Contact your administrator");
        try {
            aem.validateWebServiceCall("getActivityAuditTrail", ipAddress, sessionId);
    ...
    public List<RemoteBookmark> objectIsBookmarkItemIn(String objectClass, long objectId, String ipAddress, String sessionId) throws ServerSideException {
        ...
        try {
            aem.validateWebServiceCall("objectIsBookmarkItemIn", ipAddress, sessionId);
            
            List<RemoteBookmark> remoteBookmarks = new ArrayList();
            List<Bookmark> bookmarks = aem.objectIsBookmarkItemIn(objectClass, objectId);
