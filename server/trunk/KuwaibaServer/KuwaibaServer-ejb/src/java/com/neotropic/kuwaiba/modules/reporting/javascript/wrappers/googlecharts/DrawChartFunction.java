 ...
 */
package com.neotropic.kuwaiba.modules.reporting.javascript.wrappers.googlecharts;
 ...
 */
public class DrawChartFunction extends JavaScriptFunction {
    /**
     ...
     */
    public DrawChartFunction(String functionName, String chartTitle, DataTable dataTable, ChartType chartType, HTMLDiv htmlDiv) {
        super(functionName);
