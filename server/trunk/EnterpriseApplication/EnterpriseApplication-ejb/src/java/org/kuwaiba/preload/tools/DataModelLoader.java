...
/**
 * Creates the initial schema needed to load the kuwiaba data model in a neo4j implementation
...
public class DataModelLoader {
    ...
    public boolean loadDataModel() throws IOException, Exception{
        try 
        {
            ...
            reader.read(XMLBackupReader.getBytesFromFile(classHierarchyFile));
            createDummyroot();
