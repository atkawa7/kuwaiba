...
public class KuwaibaService {
   ...
   /**
     ...
     * @throws ServerSideException
     */
    @WebMethod(operationName = "createScriptQuery")
    public long createScriptQuery(
        @WebParam(name = "name") String name, 
        @WebParam(name = "description") String description, 
        @WebParam(name = "script") String script, 
        @WebParam(name = "parameters") List<StringPair> parameters, 
        ...
        try {                
            ...
            if (e instanceof ServerSideException)
                ...
                System.out.println("[KUWAIBA] An unexpected error occurred in createScriptQuery: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }
     ...
     * @throws ServerSideException If the script query could not be found
     */
    @WebMethod(operationName = "updateScriptQueryProperties")
    public void updateScriptQueryProperties(
        @WebParam(name = "scripQueryId") long scriptQueryId, 
        @WebParam(name = "propertyName") String propertyName, 
        @WebParam(name = "propertyValue") String propertyValue, 
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
        
        try {
            wsBean.updateScriptQueryProperties(scriptQueryId, propertyName, propertyValue, getIPAddress(), sessionId);
            
        } catch(Exception e) {
            if (e instanceof ServerSideException)
                throw e;
            else {
                System.out.println("[KUWAIBA] An unexpected error occurred in updateScriptQuery: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }
     ...
     * @throws ServerSideException If the script query could not be found
     */
    @WebMethod(operationName = "updateScriptQueryParameters")
    public void updateScriptQueryParameters(
        @WebParam(name = "scriptQueryId") long scriptQueryId, 
        @WebParam(name = "parameters") List<StringPair> parameters, 
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
        
        try {
            wsBean.updateScriptQueryParameters(scriptQueryId, parameters, getIPAddress(), sessionId);
            
        } catch(Exception e) {
            if (e instanceof ServerSideException)
                throw e;
            else {
                System.out.println("[KUWAIBA] An unexpected error occurred in updateScriptQueryParameters: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }    
     ...
     * @throws ServerSideException If the script query could not be found
     */
    @WebMethod(operationName = "getScriptQuery")
    public RemoteScriptQuery getScriptQuery(
        @WebParam(name = "scriptQueryId") long scriptQueryId, 
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
        
        try {
            return wsBean.getScriptQuery(scriptQueryId, getIPAddress(), sessionId);
            
        } catch (Exception e) {
            if (e instanceof ServerSideException)
                throw e;
            else {
                System.out.println("[KUWAIBA] An unexpected error occurred in getScriptQuery: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }
     ...
     * @throws ServerSideException If the script query could not be found
     */
    @WebMethod(operationName = "getScriptQueries")
    public List<RemoteScriptQuery> getScriptQueries(
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
                
        try {
            return wsBean.getScriptQueries(getIPAddress(), sessionId);
            
        } catch (Exception e) {
            if (e instanceof ServerSideException)
                throw e;
            else {
                System.out.println("[KUWAIBA] An unexpected error occurred in getScriptQueries: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }
     ...
     * @throws ServerSideException If the script query could not be found
     */
    @WebMethod(operationName = "deleteScriptQuery")
    public void deleteScriptQuery(
        @WebParam(name = "scriptQueryId") long scriptQueryId, 
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
        
        try {
            wsBean.deleteScriptQuery(scriptQueryId, getIPAddress(), sessionId);
            
        } catch (Exception e) {
            if (e instanceof ServerSideException)
                throw e;
            else {
                System.out.println("[KUWAIBA] An unexpected error occurred in deleteScriptQuery: " + e.getMessage());
                throw new RuntimeException("An unexpected error occurred. Contact your administrator.");
            }
        }
    }
     ...
     */
    @WebMethod(operationName = "executeScriptQuery")
    public RemoteScriptQueryResult executeScriptQuery(
        @WebParam(name = "scriptQueryId") long scriptQueryId, 
        @WebParam(name = "sessionId") String sessionId) throws ServerSideException {
        
        try {
            return wsBean.executeScriptQuery(scriptQueryId, getIPAddress(), sessionId);
