 ...
 */
public class ScriptQueryManager /*implements AbstractScriptQueryExecutor*/ {
...
//        
//    @Override
//    public Object executeScriptQuery(String scriptQueryName, HashMap<String, String> parameters) {
