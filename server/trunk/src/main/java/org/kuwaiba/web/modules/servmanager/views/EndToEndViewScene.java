...
//                addComponent(new Label(service + ": This service does not have any resources associated to"));
//            else {
...
//
//                        this.lienzoComponent.addNodeWidget(new SrvNodeWidget(aSideEquipmentLogical.getId()));
//
//                        //Now the other side
...
//
//                        this.lienzoComponent.addNodeWidget(new SrvNodeWidget(bSideEquipmentLogical.getId()));
//
