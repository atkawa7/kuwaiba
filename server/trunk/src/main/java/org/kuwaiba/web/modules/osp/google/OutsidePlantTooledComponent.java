...
//            OSPTopComponent map = ((OutsidePlantComponent) parentComponent).getGoogleMapWrapper().getMap();
//                        
//////            setButtonSelected(btnConnect, false);
//            setButtonSelected(btnNewContainer, false);
//            setButtonSelected(btnNewLink, false);
...
////        });
////        cboSearch.setEmptySelectionAllowed(true);
////        cboSearch.setValue(null);
////        cboSearch.setEmptySelectionAllowed(null);
////        //TODO: deafult size
