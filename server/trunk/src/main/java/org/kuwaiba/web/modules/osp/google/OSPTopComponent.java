...
////
////                        List<RemoteClassMetadataLight> linkClasses = null;
////                        List<RemoteClassMetadataLight> containerClasses = null;
////////                        try {
...
//            RawContextMenu rawContextMenu = new RawContextMenu(
//                ((Polygon) clickedPolygon).getActions(), OSPTopComponent.this, clickedPolygon);
//            rawContextMenu.show();
//        }
//    };
//    
...
//                    
//                    xmlew.add(xmlef.createAttribute(new QName("id"), 
//                            Long.toString(physicalConnection.getConnectionInfo().getId())));
...
//
//            if (wizardInterface.isWizardCompleted()) {
//                if (newConnection.getConnectionInfo().getId() != -1L) {
//
...
//        long oid = (Long) event[0].getValue();
//        String newValue = (String) event[1].getValue();
//        
...
////        
////        Grid.ItemClick itemClickEvent = new ItemClickEvent(dynamicTree, null, clickedInventoryObjectNode, null, null);
