                ...
                if (event == XMLStreamConstants.START_ELEMENT){
                    if (reader.getName().equals(qEdge)){
                        ...
                        if (currentASideId.equals(id)){ 
                            ...
                            if(!currentBSideId.equals("-1") && currentEndpointB != null && currentEndpointB.getName().equals(syncDestinyPortName)) //also check if the sideB match with the destiny port name
