 ...
 */
public class SnmpCpwVcMplsTableMibResourceDefinition extends HashMap<String, OID>{

    public SnmpCpwVcMplsTableMibResourceDefinition() {
        ...
        //put("cpwVcTable", new OID("1.3.6.1.4.1.9.10.106.1.2"));
    }
