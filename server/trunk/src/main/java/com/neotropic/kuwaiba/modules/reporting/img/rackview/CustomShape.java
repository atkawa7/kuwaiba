...
public class CustomShape extends Shape {
    ...
    private Image icon;
    private RemoteObject listItem;
        
    public CustomShape(RemoteObject listItem) {
        super();
        this.listItem = listItem;
        setOpaque(false);
    }
    
    public CustomShape(RemoteObject object, Image icon) {
        this(object);
        this.icon = icon;
    }
    ...
    public RemoteObject getListItem() {
        return listItem;        
    }
    
    public void setListItem(RemoteObject object) {
