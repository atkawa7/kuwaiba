...
\begin{document}
	...
	\section{Physical Connections} \label{sec:physical_connections}
		...
		\subsection{Example 2}	
			...
			\begin{enumerate}
					...
					\end{figure}			
					\item In the second step, we fill in the basic fields, but in addition to what we have already seen, it's also necessary to provide information about what's going to be contained inside the \textbf{WireContainer} and how many of those elements are to be created. Since this example is about connecting fibers, we select \textbf{OpticalLink} in the field \textit{Children type} and 20 in \textit{Num of children} just for the sake of the example.
					\begin{figure}[h!]
						\centering
	...
	\section{SDH Networks}
		...
		\section{Projects}\label{sec:projects}
		    ...
		    To start using the Projects module you must create a Project. Depending on the loaded data model you can create a  GeneralPurposeProject or NetworkProject or any subclass of GenericProject (see \textbf{\nameref{sec:data_model_manager}} if you need to create a different kind  of Project).
		    \newline
