...
\begin{document}
	...
	\subsection{Default View} \label{sec:default_view}
		...
		\begin{table}[h!]
			...
			\begin{tabular}[h!]{lp{10cm}}
				...
				\midrule
				\includegraphics[width=0.5cm]{img/icon_save_view.png} & Save view\\
				\midrule
				\includegraphics[width=0.5cm]{img/icon_add_background.png} & Add background\\
				\midrule
				...
				\midrule
				\includegraphics[width=0.5cm]{img/icon_view_type.png} & View type. Currently, only the default view and the rack view are available (see \textbf{\nameref{sec:rack_view}} for more details on the latter)\\
			\end{tabular}
		\end{table}
	...
	\section{Physical Connections} \label{sec:physical_connections}
		...
		\subsection{Example 1} \label{sec:physical_connections_example_1}
			...
			\end{figure}
			\begin{framed} {\large \textbf{Important}}\\
				Don't forget to save the view using the icon \includegraphics[width=0.5cm]{img/icon_save_view.png} in the toolbar, so your positioning changes are stored.
			\end{framed}
	...
	\newpage
	\section{SDH Networks Module} \label{sec:sdh_module}
	...
	\newpage
	\section{Task Manager Manager} \label{sec:task_manager}
\end{document}