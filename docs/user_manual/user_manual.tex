...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.9\linewidth]{img/device_layout_ipboard.png}
		\caption{Editing IPBoard Layout}
		\label{fig:device_layout_ipboard}
	\end{figure}
    \newpage
	
	Once defined the devices layout you can create a new object from template and use the action \textbf{Show $\rightarrow$ Device Layout} to see the render, for the case of the A9K-MPA-4X10GE IPBoard that no has layout, shown a default device layout \textbf{Figure~\ref{fig:device_layout_render}}.
	
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.9\linewidth]{img/device_layout_show.png}
	...
	\subsection{Object View} \label{sec:default_view}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=0.9\linewidth]{img/rack_view_connections.png}
