...
\begin{document}
	...
	\begin{figure}[b]
		\centering System Version \textbf{1.1}
	...
	Now you can create objects from templates. Just right-click on the parent object and select the \textbf{New Object from Template...} action.\\
	\begin{figure}[h!]
		\centering
	...
	\section{SDH Networks}
		...
		\newline For IPv4 address you could use 182.5.13.0/26 and will be accepted, remember de CIDR Format. 
		\newline For a IPv6 address you could use a compress or a expand notation for example you could use 2000::/3 or 2000:0000:0000:0000:0000:0000:0000:0000/3 both will be accepted.
		\begin{figure}[h!]
			\centering
