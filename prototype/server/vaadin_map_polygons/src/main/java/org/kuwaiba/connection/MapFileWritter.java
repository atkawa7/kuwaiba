        ...
        try {
            ...
            for (MapPolygon mapPolygon : mapPolygons) {
                ...
                for (LatLon coordinate : coordinates) {
                    ...
                    xmlew.add(xmlef.createStartElement(qNameVertex, null, null));
                    xmlew.add(xmlef.createAttribute(new QName("lat"), Double.toString(coordinate.getLat())));
                    xmlew.add(xmlef.createAttribute(new QName("lon"), Double.toString(coordinate.getLon())));
                    xmlew.add(xmlef.createEndElement(qNameVertex, null));
                }                
