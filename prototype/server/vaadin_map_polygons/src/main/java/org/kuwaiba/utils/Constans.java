...
public class Constans {
    ...
    public static final String controlPointIconUrl = "VAADIN/img/controlPoint_.png";
    
    public static final String unselectedConnColor = "green";
